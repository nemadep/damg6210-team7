...
*/
    manage_users_and_access.grant_role_to_user('sysadmin1', 'sysadmin');
    manage_users_and_access.grant_role_to_user('supervisor1', 'supervisor');
    manage_users_and_access.grant_role_to_user('sysadmin1', 'sysadmin');
    manage_users_and_access.grant_role_to_user('resident1', 'resident');
    manage_users_and_access.grant_role_to_user('proctor1', 'proctor');
    manage_users_and_access.grant_role_to_user('police1', 'police');
