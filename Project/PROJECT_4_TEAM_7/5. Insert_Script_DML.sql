...
BEGIN
    ...
    insertdormmanagementdata.insertstudent('Averil Nunes Nabarro', '(286) 8300224', '07-Oct-1991', 'M', 'TRUE',
                                          '7867 Hoffman Crossing', 'anunesms@ftc.gov');

    insertdormmanagementdata.insertstudent('Allister Beeton', '(181) 6435361', '25-Jul-2001', 'M', 'TRUE',
                                          '2 Larry Parkway', 'abeetonmt@upenn.edu');

    insertdormmanagementdata.insertstudent('Cate Abelov', '(338) 9878163', '16-Dec-1996', 'F', 'TRUE',
                                          '266 Eastwood Way', 'cabelovmu@wordpress.org');

    insertdormmanagementdata.insertstudent('Celestia Oldcote', '(300) 7253092', '06-Jul-1999', 'F', 'TRUE',
                                          '9628 Dahle Avenue', 'coldcotemv@domainmarket.com');

    insertdormmanagementdata.insertstudent('Evy Filipczynski', '(952) 7726295', '05-Jul-1996', 'F', 'TRUE',
                                          '499 Straubel Avenue', 'efilipczynskimw@goodreads.com');

    insertdormmanagementdata.insertstudent('Tamarah Dansken', '(382) 1368848', '14-May-1991', 'F', 'TRUE',
                                          '844 Lien Lane', 'tdanskenmx@lulu.com');

    insertdormmanagementdata.insertstudent('Tori Felipe', '(377) 6547205', '21-Mar-1999', 'F', 'TRUE',
                                          '6413 Fordem Center', 'tfelipemy@howstuffworks.com');

    insertdormmanagementdata.insertstudent('Sybila von Hagt', '(530) 2743642', '21-Jul-2000', 'F', 'TRUE',
                                          '9710 Ruskin Crossing', 'svonmz@yahoo.com');

    insertdormmanagementdata.insertstudent('Gene Daud', '(420) 9172174', '29-Oct-1993', 'M', 'TRUE',
                                          '15 John Wall Trail', 'gdaudn0@ning.com');

    insertdormmanagementdata.insertstudent('Verla Boakes', '(582) 7688719', '04-Jun-1991', 'F', 'TRUE',
                                          '24 Red Cloud Terrace', 'vboakesn1@exblog.jp');

    insertdormmanagementdata.insertstudent('Donny Bondy', '(548) 2349753', '26-Aug-1990', 'F', 'TRUE',
                                          '7 Dorton Center', 'dbondyn2@nbcnews.com');

    insertdormmanagementdata.insertstudent('Aurthur Oseman', '(103) 5968215', '08-Jul-1991', 'M', 'TRUE',
                                          '25 Dayton Avenue', 'aosemann3@bloglovin.com');

    insertdormmanagementdata.insertstudent('Germaine Woonton', '(320) 5313714', '23-Jul-1993', 'M', 'TRUE',
                                          '90502 Brentwood Alley', 'gwoontonn4@jugem.jp');

    insertdormmanagementdata.insertstudent('Red Verriour', '(253) 3777185', '27-Jan-1997', 'M', 'TRUE',
                                          '16 Eliot Terrace', 'rverriourn5@timesonline.co.uk');

    insertdormmanagementdata.insertstudent('Braden Randleson', '(260) 5922389', '23-Feb-1990', 'M', 'TRUE',
                                          '10934 Kennedy Crossing', 'brandlesonn6@springer.com');

    insertdormmanagementdata.insertstudent('Bernette Deverell', '(962) 8542325', '29-Jul-1995', 'F', 'TRUE',
                                          '24 Atwood Point', 'bdeverelln7@geocities.jp');

    insertdormmanagementdata.insertstudent('Jorge Lohoar', '(961) 9994673', '04-Jul-2002', 'M', 'TRUE',
                                          '533 Del Sol Pass', 'jlohoarn8@merriam-webster.com');

    insertdormmanagementdata.insertstudent('Horatio Twoohy', '(695) 3967452', '25-Feb-2001', 'M', 'TRUE',
                                          '312 Becker Way', 'htwoohyn9@freewebs.com');

    insertdormmanagementdata.insertstudent('Briny Bolderson', '(808) 8013335', '01-Sep-1998', 'F', 'TRUE',
                                          '1 Garrison Way', 'bboldersonna@adobe.com');

    insertdormmanagementdata.insertstudent('Rozella Girvin', '(507) 3947692', '12-Jun-1997', 'F', 'TRUE',
                                          '3682 Westport Lane', 'rgirvinnb@free.fr');

    insertdormmanagementdata.insertstudent('Horatio Wooler', '(276) 5069098', '23-Jan-2001', 'M', 'TRUE',
                                          '59 Donald Park', 'hwoolernc@ebay.com');

    insertdormmanagementdata.insertstudent('Carole Whitbread', '(896) 9804786', '26-Oct-1998', 'F', 'TRUE',
                                          '5 Jenna Court', 'cwhitbreadnd@google.nl');

    insertdormmanagementdata.insertstudent('Teddy Corke', '(791) 9324365', '29-May-2000', 'M', 'TRUE',
                                          '520 Upham Circle', 'tcorkene@csmonitor.com');

    insertdormmanagementdata.insertstudent('Stephine Minucci', '(700) 3055165', '08-Mar-1994', 'F', 'TRUE',
                                          '7 Saint Paul Point', 'sminuccinf@cmu.edu');

    insertdormmanagementdata.insertstudent('Kane Povlsen', '(353) 7108064', '01-Sep-1996', 'M', 'TRUE',
    ...
    insertdormmanagementdata.insertstudent('Saul Domokos', '(370) 3491530', '20-Aug-1990', 'M', 'TRUE',
                                          '769 Waubesa Trail', 'sdomokosni@reuters.com');

    insertdormmanagementdata.insertstudent('Elihu Shepcutt', '(838) 3487696', '16-Sep-1999', 'M', 'TRUE',
                                          '6 Bonner Lane', 'eshepcuttnj@timesonline.co.uk');

    insertdormmanagementdata.insertstudent('Terry Skule', '(599) 5522357', '10-Dec-1998', 'M', 'TRUE',
                                          '6 Grasskamp Hill', 'tskulenk@newyorker.com');

    insertdormmanagementdata.insertstudent('Chrotoem Pentony', '(561) 9619718', '29-Apr-1996', 'M', 'TRUE',
                                          '8351 Riverside Plaza', 'cpentonynl@dmoz.org');

    insertdormmanagementdata.insertstudent('Franny Sim', '(175) 4007192', '17-Jul-2000', 'F', 'TRUE',
                                          '74253 Fordem Court', 'fsimnm@liveinternet.ru');

    insertdormmanagementdata.insertstudent('Townsend Ratcliffe', '(953) 2805539', '24-May-1999', 'M', 'TRUE',
    ...
    insertdormmanagementdata.insertstudent('Solomon Meredith', '(964) 5978546', '12-Dec-1994', 'M', 'TRUE',
                                          '871 Forster Alley', 'smeredithnp@fotki.com');

    insertdormmanagementdata.insertstudent('Cristine Shales', '(825) 6378916', '26-Aug-1991', 'F', 'TRUE',
                                          '3 Orin Trail', 'cshalesnq@amazon.com');

    insertdormmanagementdata.insertstudent('Neville Beddard', '(432) 5051770', '15-Apr-1993', 'M', 'TRUE',
                                          '043 Vernon Circle', 'nbeddardnr@macromedia.com');

    insertdormmanagementdata.insertstudent('Farlay Twiname', '(819) 6164155', '25-Mar-2002', 'M', 'TRUE',
    ...
    insertdormmanagementdata.insertstudent('Nathanael Gresser', '(348) 9303357', '05-Oct-2001', 'M', 'TRUE',
                                          '373 Meadow Vale Court', 'ngressernu@geocities.jp');

    insertdormmanagementdata.insertstudent('Lia Miroy', '(317) 7660891', '05-Oct-1993', 'F', 'TRUE',
                                          '1786 Corry Point', 'lmiroynv@ovh.net');

    insertdormmanagementdata.insertstudent('Octavia Binding', '(397) 9544732', '06-Jul-1998', 'F', 'TRUE',
                                          '5 Jackson Circle', 'obindingnw@domainmarket.com');

    insertdormmanagementdata.insertstudent('Franny Pratley', '(722) 2726866', '20-Apr-1996', 'F', 'TRUE',
                                          '65516 Grasskamp Street', 'fpratleynx@pbs.org');

    insertdormmanagementdata.insertstudent('Elmira Garley', '(747) 9686599', '14-Feb-1999', 'F', 'TRUE',
    ...
    insertdormmanagementdata.insertstudent('Yankee Yuryshev', '(803) 8076312', '22-Dec-1995', 'M', 'TRUE',
                                          '2036 Vernon Lane', 'yyuryshevo0@sun.com');

    insertdormmanagementdata.insertstudent('Merrick Rickasse', '(577) 4792921', '06-Jun-1994', 'M', 'TRUE',
                                          '0786 Jana Alley', 'mrickasseo1@amazon.co.jp');

    insertdormmanagementdata.insertstudent('Gwennie Toy', '(118) 8383331', '17-May-1998', 'F', 'TRUE',
    ...
    insertdormmanagementdata.insertstudent('Luce Hadrill', '(385) 9428600', '16-Jul-1998', 'F', 'TRUE',
                                          '26120 Blackbird Center', 'lhadrillo4@ucoz.com');

    insertdormmanagementdata.insertstudent('Lenette Titcom', '(445) 6757103', '05-Jan-2002', 'F', 'TRUE',
                                          '13167 Leroy Junction', 'ltitcomo5@hc360.com');

    insertdormmanagementdata.insertstudent('Travis Forsdike', '(435) 9695779', '15-Jan-1999', 'M', 'TRUE',
    ...
    insertdormmanagementdata.insertstudent('Lenora Aronov', '(581) 2916973', '29-Oct-2002', 'F', 'TRUE',
                                          '38258 Shelley Hill', 'laronovo8@friendfeed.com');

    insertdormmanagementdata.insertstudent('Betta Chismon', '(518) 7861857', '16-Mar-1993', 'F', 'TRUE',
                                          '50439 Dixon Drive', 'bchismono9@wikispaces.com');

    insertdormmanagementdata.insertstudent('Lamar MacNeish', '(368) 7246274', '10-Dec-1999', 'M', 'TRUE',
    ...
    insertdormmanagementdata.insertstudent('Shurlocke Muncer', '(464) 5031659', '29-Jun-2001', 'M', 'TRUE',
                                          '8203 Meadow Valley Pass', 'smuncerod@ehow.com');

    insertdormmanagementdata.insertstudent('Lidia Klainman', '(904) 4170306', '05-Jan-2002', 'F', 'TRUE',
                                          '65 Gulseth Alley', 'lklainmanoe@addthis.com');

    insertdormmanagementdata.insertstudent('Elsy Cordes', '(213) 9721536', '27-Jun-1993', 'F', 'TRUE',
                                          '21221 Mccormick Circle', 'ecordesof@opera.com');

    insertdormmanagementdata.insertstudent('Jorie Mitchelson', '(526) 8366874', '29-Jun-2001', 'F', 'TRUE',
                                          '84 American Park', 'jmitchelsonog@posterous.com');

    insertdormmanagementdata.insertstudent('Therese Salmons', '(763) 2556071', '04-Jul-2002', 'F', 'TRUE',
                                          '56270 Barby Plaza', 'tsalmonsoh@shutterfly.com');

    insertdormmanagementdata.insertstudent('Gene Oldham', '(245) 3508424', '10-Jul-1999', 'M', 'TRUE',
                                          '69430 Village Green Drive', 'goldhamoi@joomla.org');

    insertdormmanagementdata.insertstudent('Muhammad Muckloe', '(575) 3484334', '19-Sep-1995', 'M', 'TRUE',
                                          '8 Acker Junction', 'mmuckloeoj@homestead.com');

    insertdormmanagementdata.insertstudent('Tommie Laviss', '(994) 4390876', '06-May-1991', 'M', 'TRUE',
                                          '97086 Becker Junction', 'tlavissok@edublogs.org');

    insertdormmanagementdata.insertstudent('Louella Stryde', '(702) 2699163', '22-Nov-1998', 'F', 'TRUE',
                                          '05680 Stang Lane', 'lstrydeol@ibm.com');

    insertdormmanagementdata.insertstudent('Charley Van Saltsberg', '(629) 5258810', '09-May-2001', 'M', 'TRUE',
                                          '8705 Pine View Place', 'cvanom@java.com');

    insertdormmanagementdata.insertstudent('Eugenius Delea', '(292) 5735755', '03-May-1993', 'M', 'TRUE',
                                          '73 Beilfuss Junction', 'edeleaon@wikia.com');

    insertdormmanagementdata.insertstudent('Jule Melding', '(714) 1203796', '21-Oct-1994', 'M', 'TRUE',
                                          '8 Shoshone Hill', 'jmeldingoo@google.com.au');

    insertdormmanagementdata.insertstudent('Roy Purdom', '(884) 4837344', '04-May-1996', 'M', 'TRUE',
                                          '02606 Valley Edge Pass', 'rpurdomop@businesswire.com');

    insertdormmanagementdata.insertstudent('Freddi Philpot', '(805) 9997959', '27-Sep-1999', 'F', 'TRUE',
                                          '74 Main Park', 'fphilpotoq@webmd.com');

    insertdormmanagementdata.insertstudent('Becki MacDavitt', '(381) 8558458', '14-Apr-2001', 'F', 'TRUE',
                                          '13 Ruskin Junction', 'bmacdavittor@eepurl.com');

    insertdormmanagementdata.insertstudent('Kylila Wheelhouse', '(600) 5318855', '20-Apr-1991', 'F', 'TRUE',
                                          '0750 Dwight Plaza', 'kwheelhouseos@php.net');

    insertdormmanagementdata.insertstudent('Izak Jaher', '(686) 2129366', '13-Dec-1991', 'M', 'TRUE',
                                          '5 Dryden Park', 'ijaherot@vimeo.com');

    insertdormmanagementdata.insertstudent('Corbie Goodliffe', '(224) 5096922', '25-Mar-2001', 'M', 'TRUE',
                                          '6 Crowley Place', 'cgoodliffeou@github.com');

    insertdormmanagementdata.insertstudent('Theodosia Gealy', '(849) 7892406', '23-Oct-2002', 'F', 'TRUE',
                                          '5572 Shelley Court', 'tgealyov@ifeng.com');

    insertdormmanagementdata.insertstudent('Genevieve Stammler', '(462) 3356582', '07-Sep-1992', 'F', 'TRUE',
                                          '4 Kedzie Crossing', 'gstammlerow@cpanel.net');

    insertdormmanagementdata.insertstudent('Ganny Lushey', '(532) 5794615', '25-Sep-1998', 'M', 'TRUE',
                                          '048 Warrior Place', 'glusheyox@slideshare.net');

    insertdormmanagementdata.insertstudent('Peria Ure', '(947) 5516135', '22-Jan-1998', 'F', 'TRUE',
                                          '1 Grayhawk Avenue', 'pureoy@gmpg.org');

    insertdormmanagementdata.insertstudent('Etan Couling', '(144) 7994410', '14-Nov-1999', 'M', 'TRUE',
                                          '35997 Grayhawk Way', 'ecoulingoz@uol.com.br');

    insertdormmanagementdata.insertstudent('Mario Rogez', '(835) 6064189', '14-Jul-1990', 'M', 'TRUE',
                                          '163 Buena Vista Avenue', 'mrogezp0@blogger.com');

    insertdormmanagementdata.insertstudent('Barth Hovy', '(363) 9115106', '18-Nov-1996', 'M', 'TRUE',
                                          '8699 Myrtle Terrace', 'bhovyp1@cornell.edu');

    insertdormmanagementdata.insertstudent('Tab Bigglestone', '(285) 6226940', '24-Jan-1992', 'M', 'TRUE',
                                          '053 Garrison Street', 'tbigglestonep2@nps.gov');

    insertdormmanagementdata.insertstudent('Mandy Simond', '(767) 4173741', '01-Dec-1998', 'F', 'TRUE',
                                          '972 4th Park', 'msimondp3@clickbank.net');

    insertdormmanagementdata.insertstudent('Maurise Antoni', '(205) 8117102', '25-Mar-1994', 'F', 'TRUE',
                                          '667 Clemons Trail', 'mantonip4@hc360.com');

    insertdormmanagementdata.insertstudent('El Lafrentz', '(934) 5106686', '15-Jul-2002', 'M', 'TRUE',
                                          '8791 Algoma Junction', 'elafrentzp5@ask.com');

    insertdormmanagementdata.insertstudent('Mannie Housden', '(433) 8024947', '16-Nov-1995', 'M', 'TRUE',
                                          '55 Schurz Court', 'mhousdenp6@wisc.edu');

    insertdormmanagementdata.insertstudent('Claybourne MacLeod', '(774) 5703610', '26-Jul-1990', 'M', 'TRUE',
                                          '17605 Maywood Crossing', 'cmacleodp7@admin.ch');

    insertdormmanagementdata.insertstudent('Tadeas Burstow', '(436) 7940472', '22-Aug-2000', 'M', 'TRUE',
                                          '18157 Derek Court', 'tburstowp8@youku.com');

    insertdormmanagementdata.insertstudent('Livia Handford', '(433) 3214695', '15-Oct-1996', 'F', 'TRUE',
                                          '9482 Monica Plaza', 'lhandfordp9@blog.com');

    insertdormmanagementdata.insertstudent('Brenna MacFaul', '(376) 6927015', '11-Oct-1998', 'F', 'TRUE',
                                          '954 Steensland Point', 'bmacfaulpa@japanpost.jp');

    insertdormmanagementdata.insertstudent('Martguerita Clinch', '(739) 6667507', '28-Feb-1995', 'F', 'TRUE',
                                          '6 Springview Circle', 'mclinchpb@state.gov');

    insertdormmanagementdata.insertstudent('Patrizia Lyngsted', '(782) 4575762', '15-Mar-2002', 'F', 'TRUE',
                                          '72 Stuart Park', 'plyngstedpc@shinystat.com');

    insertdormmanagementdata.insertstudent('Kerstin Valentelli', '(784) 6595451', '01-May-1995', 'F', 'TRUE',
                                          '220 Scott Plaza', 'kvalentellipd@tinypic.com');

    insertdormmanagementdata.insertstudent('Joanie Naptin', '(993) 5836834', '16-Feb-1990', 'F', 'TRUE',
                                          '160 Anderson Place', 'jnaptinpe@is.gd');

    insertdormmanagementdata.insertstudent('Georg Irdale', '(249) 3070277', '05-Apr-1998', 'M', 'TRUE',
                                          '79 Scott Center', 'girdalepf@yahoo.co.jp');

    insertdormmanagementdata.insertstudent('Alyse Kuhl', '(361) 1008302', '22-Jun-1992', 'F', 'TRUE',
                                          '8 Schlimgen Road', 'akuhlpg@timesonline.co.uk');

    insertdormmanagementdata.insertstudent('Tremaine Levesley', '(670) 2019647', '01-Jun-1992', 'M', 'TRUE',
                                          '807 Fair Oaks Alley', 'tlevesleyph@shop-pro.jp');

    insertdormmanagementdata.insertstudent('Jesselyn Lazenby', '(203) 8680815', '15-Jul-1992', 'F', 'TRUE',
                                          '09126 Randy Parkway', 'jlazenbypi@seattletimes.com');

    insertdormmanagementdata.insertstudent('Alick Wortman', '(242) 3949791', '18-Aug-1990', 'M', 'TRUE',
                                          '841 Schiller Alley', 'awortmanpj@chron.com');

    insertdormmanagementdata.insertstudent('Ruy Kersting', '(470) 8677083', '28-Apr-2000', 'M', 'TRUE',
                                          '062 Prentice Avenue', 'rkerstingpk@tmall.com');

    insertdormmanagementdata.insertstudent('Corbett Ashlee', '(430) 2333797', '23-Jun-1992', 'M', 'TRUE',
                                          '35 Bluestem Place', 'cashleepl@yahoo.co.jp');

    insertdormmanagementdata.insertstudent('Vick Potkins', '(380) 8654274', '14-Nov-1999', 'M', 'TRUE',
                                          '1 Beilfuss Point', 'vpotkinspm@fotki.com');

    insertdormmanagementdata.insertstudent('Liv Ferney', '(521) 7226462', '28-Jun-1995', 'F', 'TRUE',
                                          '091 Dennis Crossing', 'lferneypn@slate.com');

    insertdormmanagementdata.insertstudent('Beret Adamsen', '(756) 5973570', '21-Mar-1998', 'F', 'TRUE',
                                          '88659 Summerview Hill', 'badamsenpo@furl.net');

    insertdormmanagementdata.insertstudent('Dean La Rosa', '(570) 8409406', '22-Feb-1994', 'M', 'TRUE',
                                          '6 7th Street', 'dlapp@huffingtonpost.com');

    insertdormmanagementdata.insertstudent('Antonin Fley', '(330) 2040290', '01-Mar-1993', 'M', 'TRUE',
                                          '84 Pine View Center', 'afleypq@geocities.jp');

    insertdormmanagementdata.insertstudent('Merola Vashchenko', '(160) 9569373', '22-Oct-2002', 'F', 'TRUE',
                                          '65012 Valley Edge Avenue', 'mvashchenkopr@yellowbook.com');

    insertdormmanagementdata.insertstudent('Margaux Whittuck', '(330) 3909980', '11-Nov-1996', 'F', 'TRUE',
                                          '93931 Hansons Crossing', 'mwhittuckps@godaddy.com');

    insertdormmanagementdata.insertstudent('Joe Lydster', '(323) 2404766', '24-May-1992', 'M', 'TRUE',
                                          '99 Clove Lane', 'jlydsterpt@java.com');

    insertdormmanagementdata.insertstudent('Fayette Dominelli', '(638) 7776636', '18-Dec-1990', 'F', 'TRUE',
                                          '70 Maywood Street', 'fdominellipu@omniture.com');

    insertdormmanagementdata.insertstudent('Sabine Cotter', '(867) 5095052', '20-Mar-1991', 'F', 'TRUE',
                                          '97 Mifflin Point', 'scotterpv@shinystat.com');

    insertdormmanagementdata.insertstudent('Catlaina Laxson', '(878) 1940815', '12-Nov-1999', 'F', 'TRUE',
                                          '93 Amoth Center', 'claxsonpw@wiley.com');

    insertdormmanagementdata.insertstudent('Rafi Trouncer', '(438) 2167102', '09-Jun-1997', 'M', 'TRUE',
                                          '7133 Clarendon Pass', 'rtrouncerpx@usa.gov');

    insertdormmanagementdata.insertstudent('Zachery Pizzie', '(238) 3115292', '29-Nov-2000', 'M', 'TRUE',
                                          '82628 Mallard Way', 'zpizziepy@ed.gov');

    insertdormmanagementdata.insertstudent('Weber Arlett', '(856) 7309613', '25-Apr-1996', 'M', 'TRUE',
                                          '3 Kedzie Road', 'warlettpz@free.fr');

    insertdormmanagementdata.insertstudent('Willyt Laible', '(432) 6061916', '03-Jan-1992', 'F', 'TRUE',
                                          '48118 Delladonna Point', 'wlaibleq0@cbslocal.com');

    insertdormmanagementdata.insertstudent('Yetta Cahen', '(614) 8955259', '02-Jan-1992', 'F', 'TRUE',
                                          '8 Rigney Pass', 'ycahenq1@hexun.com');

    insertdormmanagementdata.insertstudent('Shay Gilstoun', '(478) 8240103', '08-Sep-1992', 'M', 'TRUE',
                                          '49163 Delladonna Center', 'sgilstounq2@hao123.com');

    insertdormmanagementdata.insertstudent('Rania Baker', '(467) 7214604', '24-Jun-1992', 'F', 'TRUE',
                                          '0 Carioca Place', 'rbakerq3@webeden.co.uk');

    insertdormmanagementdata.insertstudent('Hersch Kalinowsky', '(238) 7467534', '08-Jul-1995', 'M', 'TRUE',
                                          '33697 Paget Court', 'hkalinowskyq4@cafepress.com');

    insertdormmanagementdata.insertstudent('Fairfax Dounbare', '(375) 2564674', '01-May-1997', 'M', 'TRUE',
                                          '9669 Pepper Wood Drive', 'fdounbareq5@mit.edu');

    insertdormmanagementdata.insertstudent('Arlie Wolseley', '(167) 8201322', '18-Sep-1999', 'F', 'TRUE',
                                          '62887 Elgar Avenue', 'awolseleyq6@businesswire.com');

    insertdormmanagementdata.insertstudent('Charlena Slora', '(878) 9258528', '13-Mar-1999', 'F', 'TRUE',
                                          '12770 Park Meadow Park', 'csloraq7@google.ca');

    insertdormmanagementdata.insertstudent('Lucio Hamnett', '(931) 6076335', '16-Jan-1990', 'M', 'TRUE',
                                          '999 Ryan Lane', 'lhamnettq8@ow.ly');

    insertdormmanagementdata.insertstudent('Dulcinea Antushev', '(117) 3965375', '11-Aug-1993', 'F', 'TRUE',
                                          '34010 Tomscot Trail', 'dantushevq9@twitpic.com');

    insertdormmanagementdata.insertstudent('Robbie Ralfe', '(650) 2214679', '11-Jun-1993', 'F', 'TRUE',
                                          '3480 Loeprich Center', 'rralfeqa@google.ca');

    insertdormmanagementdata.insertstudent('Kahaleel Barkas', '(889) 7807437', '03-Mar-1990', 'M', 'TRUE',
                                          '572 Badeau Street', 'kbarkasqb@naver.com');

    insertdormmanagementdata.insertstudent('Orton Chevin', '(236) 3170897', '21-Jan-1996', 'M', 'TRUE',
                                          '55691 Victoria Circle', 'ochevinqc@addtoany.com');

    insertdormmanagementdata.insertstudent('Adi Zupo', '(379) 2791746', '06-Nov-1993', 'F', 'TRUE',
                                          '94 Vidon Lane', 'azupoqd@amazon.de');

    insertdormmanagementdata.insertstudent('Bartholemy Bownde', '(647) 4421876', '21-Sep-2001', 'M', 'TRUE',
                                          '7 Springs Junction', 'bbowndeqe@thetimes.co.uk');

    insertdormmanagementdata.insertstudent('Jacquelynn Mackilpatrick', '(313) 5988863', '11-Aug-1990', 'F', 'TRUE',
                                          '6258 Blackbird Court', 'jmackilpatrickqf@nydailynews.com');

    insertdormmanagementdata.insertstudent('Job Morpeth', '(850) 9976658', '15-Jun-1994', 'M', 'TRUE',
                                          '920 Holmberg Way', 'jmorpethqg@themeforest.net');

    insertdormmanagementdata.insertstudent('Florinda Farn', '(192) 7291693', '18-May-1993', 'F', 'TRUE',
                                          '9 Vera Center', 'ffarnqh@ft.com');

    insertdormmanagementdata.insertstudent('Kettie Duggan', '(856) 4820332', '29-Dec-1990', 'F', 'TRUE',
                                          '69 Shelley Way', 'kdugganqi@google.ru');

    insertdormmanagementdata.insertstudent('Georgette Semrad', '(521) 2627879', '21-Apr-1998', 'F', 'TRUE',
                                          '111 Hintze Court', 'gsemradqj@exblog.jp');

    insertdormmanagementdata.insertstudent('Reidar Lamming', '(363) 5266932', '26-Sep-1992', 'M', 'TRUE',
                                          '3 Straubel Street', 'rlammingqk@buzzfeed.com');

    insertdormmanagementdata.insertstudent('Burtie Spata', '(839) 6426724', '06-Jun-1991', 'M', 'TRUE',
                                          '99418 Clemons Court', 'bspataql@mtv.com');

    insertdormmanagementdata.insertstudent('Lona Lantuffe', '(114) 5400520', '09-Jan-1997', 'F', 'TRUE',
                                          '8 Warner Crossing', 'llantuffeqm@nationalgeographic.com');

    insertdormmanagementdata.insertstudent('Doyle Lethlay', '(332) 9399828', '29-Apr-1999', 'M', 'TRUE',
                                          '6 David Drive', 'dlethlayqn@booking.com');

    insertdormmanagementdata.insertstudent('Ivor Wasiel', '(984) 4061362', '02-Dec-1992', 'M', 'TRUE',
                                          '49 Fordem Place', 'iwasielqo@msu.edu');

    insertdormmanagementdata.insertstudent('Jacquenette Scoines', '(371) 4900174', '28-Sep-1992', 'F', 'TRUE',
                                          '8 Mesta Park', 'jscoinesqp@boston.com');

    insertdormmanagementdata.insertstudent('Kelcey Fentem', '(417) 4985242', '02-Mar-1995', 'F', 'TRUE',
                                          '17333 Holmberg Lane', 'kfentemqq@addtoany.com');

    insertdormmanagementdata.insertstudent('Ole Lampen', '(825) 1524367', '30-Jul-1998', 'M', 'TRUE',
                                          '089 Florence Way', 'olampenqr@addtoany.com');

    insertdormmanagementdata.insertstudent('Lorena Mordin', '(642) 6443315', '29-Aug-1995', 'F', 'TRUE',
                                          '0 Delladonna Way', 'lmordinqs@npr.org');

    insertdormmanagementdata.insertstudent('Hew Schwaiger', '(912) 4787530', '01-Feb-1998', 'M', 'TRUE',
                                          '99173 Harper Plaza', 'hschwaigerqt@vistaprint.com');

    insertdormmanagementdata.insertstudent('Burke Kimmerling', '(275) 8917498', '22-Feb-1993', 'M', 'TRUE',
                                          '0 Moose Hill', 'bkimmerlingqu@amazon.de');

    insertdormmanagementdata.insertstudent('Bald Dacey', '(736) 4243118', '18-Jun-1997', 'M', 'TRUE',
                                          '31744 Utah Point', 'bdaceyqv@stumbleupon.com');

    insertdormmanagementdata.insertstudent('Alaster Bigglestone', '(356) 2589464', '15-Dec-1990', 'M', 'TRUE',
                                          '5 Grasskamp Center', 'abigglestoneqw@sitemeter.com');

    insertdormmanagementdata.insertstudent('Em Leeves', '(534) 5255440', '02-Feb-1993', 'M', 'TRUE',
                                          '42 Schiller Plaza', 'eleevesqx@go.com');

    insertdormmanagementdata.insertstudent('Humfrey Mockett', '(720) 2459156', '27-Feb-1997', 'M', 'TRUE',
                                          '97878 Meadow Ridge Road', 'hmockettqy@bandcamp.com');

    insertdormmanagementdata.insertstudent('Abra Filyakov', '(433) 3196053', '27-Dec-1992', 'F', 'TRUE',
                                          '0194 Caliangt Alley', 'afilyakovqz@linkedin.com');

    insertdormmanagementdata.insertstudent('Denys Lugsdin', '(263) 2040408', '31-Mar-2000', 'M', 'TRUE',
                                          '87287 Quincy Pass', 'dlugsdinr0@google.co.uk');

    insertdormmanagementdata.insertstudent('Gloriane Albrook', '(480) 4709799', '06-Apr-2000', 'F', 'TRUE',
                                          '5022 Superior Circle', 'galbrookr1@eventbrite.com');

    insertdormmanagementdata.insertstudent('Eugenius Priestner', '(962) 5198972', '04-Jul-1992', 'M', 'TRUE',
                                          '1 Texas Trail', 'epriestnerr2@w3.org');

    insertdormmanagementdata.insertstudent('Tedie Sawyers', '(993) 6969352', '14-May-1999', 'M', 'TRUE',
                                          '1923 Golf View Road', 'tsawyersr3@wix.com');

    insertdormmanagementdata.insertstudent('Obidiah Gary', '(471) 7154591', '30-Jan-1995', 'M', 'TRUE',
                                          '474 Cascade Place', 'ogaryr4@about.com');

    insertdormmanagementdata.insertstudent('Denys Mullaly', '(147) 9710856', '27-Jun-1999', 'M', 'TRUE',
                                          '52534 Lyons Place', 'dmullalyr5@discuz.net');

    insertdormmanagementdata.insertstudent('Happy Athey', '(485) 1729979', '18-Nov-2002', 'F', 'TRUE',
                                          '88256 Johnson Crossing', 'hatheyr6@economist.com');

    insertdormmanagementdata.insertstudent('Tessy Treleven', '(349) 9599390', '12-Apr-1993', 'F', 'TRUE',
                                          '242 Dottie Park', 'ttrelevenr7@ebay.com');

    insertdormmanagementdata.insertstudent('Heda Quincey', '(815) 1822231', '27-Oct-1996', 'F', 'TRUE',
                                          '0611 Dryden Avenue', 'hquinceyr8@163.com');

    insertdormmanagementdata.insertstudent('Kala Turton', '(290) 1456071', '02-Jun-2002', 'F', 'TRUE',
                                          '28983 Arrowood Lane', 'kturtonr9@auda.org.au');

    insertdormmanagementdata.insertstudent('Risa Dowrey', '(463) 8575906', '18-Apr-1997', 'F', 'TRUE',
                                          '6616 Mifflin Street', 'rdowreyra@freewebs.com');

    insertdormmanagementdata.insertstudent('Con Perrigo', '(100) 1754512', '16-Apr-1992', 'M', 'TRUE',
                                          '306 Fremont Avenue', 'cperrigorb@ucoz.ru');

    insertdormmanagementdata.insertstudent('Emilio Mazzilli', '(122) 2413274', '04-Jul-1999', 'M', 'TRUE',
                                          '92402 Crescent Oaks Street', 'emazzillirc@who.int');

    insertdormmanagementdata.insertstudent('Joellen Klaggeman', '(864) 1965468', '19-Sep-1994', 'F', 'TRUE',
                                          '554 Union Pass', 'jklaggemanrd@vinaora.com');

    insertdormmanagementdata.insertstudent('Nev Fernando', '(402) 8208838', '13-Apr-1995', 'M', 'TRUE',
                                          '811 Leroy Hill', 'nfernandore@alexa.com');

    insertdormmanagementdata.insertstudent('Adelind Garett', '(434) 4402309', '26-Sep-2000', 'F', 'TRUE',
                                          '094 Dahle Drive', 'agarettrf@google.co.jp');

    insertdormmanagementdata.insertstudent('Bobbee Laidel', '(511) 6050953', '03-Dec-1990', 'F', 'TRUE',
                                          '34263 Scoville Point', 'blaidelrg@list-manage.com');

    insertdormmanagementdata.insertstudent('Danika Hurley', '(559) 4070013', '21-Mar-1997', 'F', 'TRUE',
                                          '0 Northview Terrace', 'dhurleyrh@noaa.gov');

    insertdormmanagementdata.insertstudent('Aloysius Hymus', '(185) 9832118', '18-May-1990', 'M', 'TRUE',
                                          '18748 Vahlen Avenue', 'ahymusri@pbs.org');

    insertdormmanagementdata.insertstudent('Allis Gitsham', '(531) 7415677', '14-May-2002', 'F', 'TRUE',
                                          '885 Talisman Plaza', 'agitshamrj@dell.com');

    insertdormmanagementdata.insertstudent('Rancell Rice', '(319) 7586986', '15-Dec-2000', 'M', 'TRUE',
                                          '2998 Lotheville Point', 'rricerk@narod.ru');

    insertdormmanagementdata.insertstudent('Dunstan Dael', '(314) 2478408', '21-Oct-2000', 'M', 'TRUE',
                                          '6970 Green Circle', 'ddaelrl@illinois.edu');

    insertdormmanagementdata.insertstudent('Mariel Keach', '(717) 1831235', '17-May-1991', 'F', 'TRUE',
                                          '61212 Waywood Court', 'mkeachrm@china.com.cn');

    insertdormmanagementdata.insertstudent('Yolanthe Gaspar', '(433) 3303775', '30-Dec-1993', 'F', 'TRUE',
                                          '26030 Clove Center', 'ygasparrn@liveinternet.ru');

    insertdormmanagementdata.insertstudent('Gerda Duchateau', '(193) 4634234', '09-Oct-1990', 'F', 'TRUE',
                                          '537 Dennis Parkway', 'gduchateauro@examiner.com');

    insertdormmanagementdata.insertstudent('Mikael Fairburne', '(557) 7179169', '16-Sep-1991', 'M', 'TRUE',
                                          '6129 Kim Place', 'mfairburnerp@google.com.br');

    insertdormmanagementdata.insertstudent('Mellicent Tadgell', '(476) 5954480', '30-May-1994', 'F', 'TRUE',
    ...
    insertdormmanagementdata.p_swipe_me(5, 4);
    insertdormmanagementdata.p_swipe_me(6, 4);
    ...
    insertdormmanagementdata.insertproctor('Amalie Filippucci', '(883) 7732508', 'afilippucci1t@mediafire.com', '505 Gulseth Trail', '22-May-1999');
